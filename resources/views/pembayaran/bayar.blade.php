                    ...
                    <div class="row">
                        <div class="col-lg-3">
                            <div class="form-group">
                                ...
                                <input required="" type="hidden" name="atlet_id" value="{{ $atlet->id }}" readonly
                                    id="siswa_id" class="form-control">
                                <input required="" type="text" name="name" value="{{ $atlet->name }}" readonly id="name"
                                    class="form-control">
                                @error('name')
                        ...
                        <div class="col-lg-3">
                            <div class="form-group">
                                ...
                                <input required="" type="text" name="kelas" value="{{ $atlet->kelas }}" readonly
